...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotframework-tidy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14062&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotframework-tidy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotframework-tidy` can be installed with:

```
conda install robotframework-tidy
```

It is possible to list all of the versions of `robotframework-tidy` available on your platform with:
